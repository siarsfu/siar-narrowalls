...
/// <summary>
/// The listener component for head gesture input. 
/// Simply place this on an object to have it listen for head gestures, which will trigger callbacks that you can define in either the Inspector or via code.
/// </summary>
